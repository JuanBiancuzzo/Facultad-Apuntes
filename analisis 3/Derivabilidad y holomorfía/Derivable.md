...
# Definición
---
Sea $f : D \to \mathbb{C}$ una [[analisis 2/Nomenclatura/Función.md|función]] definida en un [[Conjunto abierto|conjunto abierto]] $D \subseteq \mathbb{C}$ y sea $z_0 \in D$.  Entonces_
