...
capitulo: 4
---
Son la [[Inversa local]] de la [[Función potencia]], por el [[Inversa local#Teorema de Inversibidad local]], sabemos que las inversas locales de $p_n$, que significa $\sqrt[n]{~~}$, existen en torno de cada $z_0 \ne 0$ y que son [[Holomorfa]]s. 
...
### Observación
---
Con la $\sqrt[n]{~~}$ divide el espación en $n$ regiones rotadas con respecto al origen.
