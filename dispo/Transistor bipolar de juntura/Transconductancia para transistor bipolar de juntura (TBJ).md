...
Calculándolo en [[Modo activo directo del TBJ|MAD]] y un [[Transistor bipolar de juntura|TBJ]] de tipo [[Transistor bipolar de juntura#NPN|NPN]], tenemos que $$ i_C = I_S \exp \left( \frac{v_{BE}}{V_{th}} \right) $$ entonces $$ g_m = \frac{\partial i_C (v_{BE})}{\partial v_{BE}} \biggm|_{Q} = \frac{I_S}{V_{th}} \exp \left( \frac{V_{BE}}{V_{th}} \right) $$ por lo que podemos reescribir como 
