...
### Definición
---
La física fundamental de la [[Corriente de difusión|difusión]] y el [[Corriente de arrastre|arrastre]] es la misma, colisiones entre partículas y los átomos del medio, por lo que podemos pensar que debe existir una relación entre el [[Coeficiente de difusión]] ($D$) y la [[Movilidad]] ($\mu$)
...
Queda entonces la relación de Einstein $$ \frac{D}{\mu} = \frac{k ~ T}{q} = V_{th} $$ donde $V_{th} = \frac{k ~ T}{q}$ es el [[Función potencial|potencial]] térmico en $[V]$
