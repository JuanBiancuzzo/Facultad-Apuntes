...
Despejando, usando el [[Función potencial]] y la [[Relación de Einstein]], nos queda $$ \frac{q}{k ~ T} \frac{d\phi(x)}{dx} = \frac{d}{dx} \ln (n_0(x)) $$ donde $k$ es la constante de Boltzmann y $K$ es la temperatura en Kelvin
