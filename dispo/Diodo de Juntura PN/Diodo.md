...
### Definición
---
El diodo es un componente electrónico de dos terminales que permite la circulación de la [[Corriente eléctrica]] a través de él en un solo sentido.
...
---
Comparemos la corriente que fluye por un diodo real en comparación al [[Corriente a través de la juntura PN|diodo ideal]]

![[El diodo ideal vs. el diodo real.png|500]]

Al medir la características de la [[Corriente eléctrica|corriente]]-[[Tensión|tensión]] de un diodo real se observa que es necesario introducir factores empíricos en la [[Corriente a través de la juntura PN|ecuación teórica]] para que la misma ajuste correctamente la curva experimental
...
En directa, la [[Portador de carga|concentración de portadores]] en la SCR aumenta respecto de [[Equilibrio térmico en un semiconductor|equilibrio térmico]] por lo que la [[Recombinación]] supera a la [[Generación]].
...
* La corriente que atraviesa la SCR puede ser comparable con la corriente de equilibrio
  ...
  $\implies$ La concentración de minoritarios en el borde de la SCR ya no responde a la [[Relación de Boltzmann]].
* Los minoritarios en el borde de la SCR aumentan considerablemente
  $\implies$ Ya no es válida la [[Hipótesis de bajo nivel de inyección]]
...
$\implies$ la [[Generación]] supera a la [[Recombinación]]
...
* Aumenta la [[Tensión|diferencia de potencial]] en la [[Juntura PN|juntura]] respecto del [[Equilibrio térmico en un semiconductor|equilibrio]], por lo que aumenta el [[Campo eléctrico]] interno $$ |E(x = 0, V_D)| = \sqrt{\frac{2q~(\phi_B-V_D)}{\varepsilon_{sc}}\frac{N_a ~ N_d}{N_a + N_d}} $$
* [[Campo eléctrico|Campos eléctricos]] elevados en la juntura pueden producir la [[Ruptura inversa]] de la [[Juntura PN|juntura]]
...
* El [[Efecto túnel]] (ocurre en juntura fuertemente [[Dopaje|dopadas]])
