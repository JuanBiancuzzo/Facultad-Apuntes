...
### Interpretación
---
Este libro se divide en 5 títulos, que se refieren respectivamente a las [[legal/Articulos/Código Civil y Comercial de la Nación/Libro Tercero/Título 1/Título 1, Disposiciones generales|"Obligaciones en general"]], a los [[Libro Tercero, Título 2, Contratos en general|"Contratos en general"]], a los [[Libro Tercero, Título 3, Contratos de consumo|"Contratos de consumo]], a los [[Libro Tercero, Título 4, Contratos en particular|"Contratos en particular"]] y, finalmente, a [[Libro Tercero, Título 5, Otras fuentes de las obligaciones|"Otras fuentes de las obligaciones"]], en donde se refiere a la responsabilidad civil, la gestión de negocios, el empleo útil, el enriquecimiento sin causa, la declaración unilateral de voluntad y a los títulos valores
