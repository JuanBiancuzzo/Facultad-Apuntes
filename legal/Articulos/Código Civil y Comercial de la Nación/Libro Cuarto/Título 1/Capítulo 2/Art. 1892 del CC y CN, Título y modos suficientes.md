---
num: 1892
nombre: Título y modos suficientes
articulo:
  - tipo: texto
    texto: La adquisición derivada por actos entre vivos de un derecho real requiere la concurrencia de título y modo suficientes.
  - tipo: texto
    texto: Se entiende por título suficiente el acto jurídico revestido de las formas establecidas por la ley, que tiene por finalidad transmitir o constituir el derecho real.
  - tipo: texto
    texto: La tradición posesoria es modo suficiente para transmitir o constituir derechos reales que se ejercen por la posesión. No es necesaria, cuando la cosa es tenida a nombre del propietario, y éste por un acto jurídico pasa el dominio de ella al que la poseía a su nombre, o cuando el que la poseía a nombre del propietario, principia a poseerla a nombre de otro. Tampoco es necesaria cuando el poseedor la transfiere a otro reservándose la tenencia y constituyéndose en poseedor a nombre del adquirente.
  - tipo: texto
    texto: La inscripción registral es modo suficiente para transmitir o constituir derechos reales sobre cosas registrables en los casos legalmente previstos; y sobre cosas no registrables, cuando el tipo del derecho así lo requiera.
  - tipo: texto
    texto: El primer uso es modo suficiente de adquisición de la servidumbre positiva.
  - tipo: texto
    texto: Para que el título y el modo sean suficientes para adquirir un derecho real, sus otorgantes deben ser capaces y estar legitimados al efecto.
  - tipo: texto
