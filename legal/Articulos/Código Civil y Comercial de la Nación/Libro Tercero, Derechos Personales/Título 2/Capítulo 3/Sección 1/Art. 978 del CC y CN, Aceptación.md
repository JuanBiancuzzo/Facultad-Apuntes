...
num_articulo: 978
art_nombre: Aceptación
art: Para que el contrato se concluya, la aceptación debe expresar la plena conformidad con la oferta. Cualquier modificación a la oferta que su destinatario hace al manifestar su aceptación, no vale como tal, sino que importa la propuesta de un nuevo contrato, pero las modificaciones pueden ser admitidas por el oferente si lo comunica de inmediato al aceptante
incisos: 
libro: Libro Tercero
título: "2"
capítulo: "3"
...
listado:
  ...
  - "[[Libro Tercero, Título 2, Capítulo 3, Sección 1, asdfasdf|Sección 1]]"
