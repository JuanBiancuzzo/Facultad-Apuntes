...
num_articulo: 780
art_nombre: Elección. Sujetos. Efectos.
art: "Excepto estipulación en contrario, la facultad de elegir corresponde al deudor. La opción que corresponde a varias personas requiere unanimidad. Si la parte a quien corresponde la elección no se pronuncia oportunamente, la facultad de opción pasa a la otra. Si esa facultad se ha deferido a un tercero y éste no opta en el plazo fijado, corresponde al deudor designar el objeto del pago."
incisos: 
libro: 3
título: "1"
capítulo: "3"
...
listado:
 ...
 - "[[Libro Tercero, Título 1, Capítulo 3, Sección 3, Obligaciones alternativas|Sección 3]]"
---
