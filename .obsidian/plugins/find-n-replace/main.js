  ...
  constructor(plugin, view, elements, searchEngine, replacementEngine, performSearchCallback, renderResultsCallback) {
    ...
    this.replaceAllKeyHandler = (event) => {
      ...
      if ((event.ctrlKey || event.metaKey) && event.key === "Enter") {
        if ((_a = activeDocument.activeElement) == null ? void 0 : _a.closest(".find-replace-container")) {
...
var FindReplaceView = class extends import_obsidian11.ItemView {
   ...
   */
  async updateResultsAfterReplacement(affectedResults, _replaceText, _searchOptions) {
    try {
