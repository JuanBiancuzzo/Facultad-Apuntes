...
Si bien el [[algo 1/Introducción a la programación/Algoritmo|algoritmo]] de control de congestión en la teoría es justo. En la práctica, los [[Host|hosts]] con menos [[Round trip time|RTT]] tienden a obtener mejor [[Throughput de una red|throughput]] que aquellos con mayor RTT
