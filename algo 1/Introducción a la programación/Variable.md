...
---
Una variable es una entidad que puede almacenar un valor de un determinado tipo de dato, y dicho valor puede ser accedido y/o modificado a lo largo del [[Algoritmo|algoritmo]]. Esta entidad se caracteriza por tener un identificador único.
...
Dadas estas características, cada celda de memoria se debe poder acceder para determinar o establecer su estado, para ello cada una de estas celdas posee una [[Puntero|dirección]], que la identifica de las otras, esta dirección es un número