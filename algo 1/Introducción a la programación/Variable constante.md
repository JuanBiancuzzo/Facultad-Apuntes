...
# Definición
---
Al igual que una variable inmutable, las constantes no pueden modificarse, pero hay diferencias entre sí. Una constante es un valor que no cambia durante todo el [[algo 1/Introducción a la programación/Algoritmo|algoritmo]], este valor posee un identificador único
