...
![[proyecto práctico/PhADAR/img/Diagrama simple de la idea.jpeg|600]]
...
Lo que tendría que investigar mejor es la utilización de phase array, transmisión continua, PLL, distintas modulaciones para la transmisión, manejo de información a altas frecuencias y el efecto que tiene la aproximación de near y far field, teniendo en cuenta que la aplicación sería para distancias cortas 
