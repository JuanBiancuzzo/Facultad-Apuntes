...
Entonces, teniendo la base $B = \{v_1, v_2, v_3, \cdots, v_n \}$, vamos a construir la base $B_p = \{w_1, w_2, w_3, \cdots, w_n \}$, siendo esta un [[ingeniería en informática/analisis 2/Nomenclatura/Ortogonalidad|sistema ortogonal]], de la siguiente forma
