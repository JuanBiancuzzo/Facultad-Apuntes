...
Esta ley se define de la siguiente forma $$ S(P) = P - \alpha (P - 1) $$ donde $S$ es el speedup, $P$ es el número de [[Procesador|procesadores]], y $\alpha$ es la porción no paralelizable del [[Proceso|proceso]]. Como se puede notar, la ley está expresada en términos de $P$
