...
# Definición
---
Un atributo es un dato lógico acerca de un objeto. Es información que debe ser recordada por el [[Sistema|sistema]]. Siempre son tipos de datos primitivos como numérico, lógico, fecha, tiempo, texto, etc. Por último, no deben incluirse atributos que referencien a otras clases conceptuales (para eso están las asociaciones)
