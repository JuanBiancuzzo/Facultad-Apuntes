...
# Definición
---
Una asociación es una relación entre instancias de una [[ingeniería en informática/ingenieria de software 1/Analizar y especificar requisitos/Clase conceptual|clase conceptual]] que debe ser recordada por el [[Sistema]]. Cada asociación tiene nombre (fase con verbo y multiplicidad).
...
## Multiplicidad
---
Indica una [[ingeniería en informática/ingenieria de software 1/Descubrimiento de requisitos/Análisis de reglas de negocio|regla de negocio]], por ejemplo, un alumno puede cursar varias o ninguna materia, una materia puede no tener alumnos