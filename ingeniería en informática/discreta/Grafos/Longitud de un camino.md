...
La [[Distancia euclidiana|distancia]] entre dos vértices es infinita si no hay un camino entre ellos, y es la longitud de un camino de longitud mínima cuando están conectados. Se denota $d(u,~ v)$, como la longitud del camino $u-v$ geodésico ([[Mínimo|mínimo]])
