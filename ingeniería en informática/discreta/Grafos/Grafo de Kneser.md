...
Si $q > p$, entonces el grafo será vacío, que es un grafo en sí mismo. La [[Función|función]] del grafo vacío se denomina función nula. Por otro laso, si $p - q < q$, entonces el grafo no tendrá aristas