...
En el caso de la [[Distribución Uniforme|Uniforme]] (que no pertenece a una familia exponencia), este se puede tomar como el caso 1, donde $T$ es $T = Max(X_1, \cdots, X_n)$ es decir su [[ingeniería en informática/proba/Inferencia estadística/Estadístico suficiente]].