...
### Definición
---
La fuerza magnética resulta proporcional a la [[Velocidad|velocidad]] de la partícula, la [[Carga eléctrica|carga]], y el [[Campo magnético|campo magnético]]. Además, es perpendicular tanto al vector velocidad como al vector campo magnético $$ \vec{F}_M = q ~ ( \vec{v} \times \vec{B} ) $$
