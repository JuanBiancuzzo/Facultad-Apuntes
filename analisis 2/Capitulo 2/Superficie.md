...
capitulo: 2
---
Dada $\vec{F} : D \subset \mathbb{R}^2 \to \mathbb{R}^3$ con $\begin{cases} D \text{ conexo} \\ \vec{F} \text{ continua en } D \end{cases}$ ([[analisis 2/Capitulo 2/Conjunto conexo]]), el conjunto imagen de $\vec{F}$ se donomina superfice
