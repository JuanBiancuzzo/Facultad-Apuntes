...
Comencemos observando el grafico, donde en rojo se representa $y =f(x)$ en un cierto [[analisis 2/Nomenclatura/Dominio de una función.md|dominio]] $D$
 ...
 * $f(x_3)$ no es [[analisis 2/Funciones de varias variables/Extremo.md|extremo]] local, pero $f'(x_3) = 0$. Recta tangente horizontal en $A_3$
...
Entonces para analizar seguimos los siguientes pasos
 ...
 2. Siendo $x_0$ un [[analisis 2/Funciones de varias variables/Punto critico.md|punto critico]], el analisis es como sigue
	 ...
	 * En esta situacion tenemos alternativas
		 ...
		 3. Si la [[analisis 2/Nomenclatura/Función.md|función]] admite [[Derivada parcial de orden superior|derivadas parciales]], suponga que con $k > 1$ la derivada la derivada de menor orden que no se anula es $f^{(k)}(x_0) \ne 0$:
