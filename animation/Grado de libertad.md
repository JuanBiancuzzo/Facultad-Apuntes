...
En mecánica clásica y [[lagrangian mechanics/Índice|lagrangiana]], la dimensión d del espacio de configuración es igual a dos veces el número de grados de libertad $GL$, $d = 2 ~ GL$
