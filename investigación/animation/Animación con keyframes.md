...
* Para correr, se puede crear un disco, el cual represente el paso que puede dar, por lo que si ese disco se agranda, el paso que puede dar es mayor ![[Representación del stride.png|300x300]] 
    * Generando dos keyframes, una para tocar el piso y otra intermedia, se puede [[ingeniería electrónica/señales/Muestreo e Interpolación/Interpolador|interpolación]] y sincronizar con el disco, asegurándonos que siempre toque correctamente el piso la animación
