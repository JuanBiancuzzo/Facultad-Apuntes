...
Podemos crear un [[ingeniería electrónica/control/Respuesta dinámica/Sistema dinámico|sistema dinámico]] de segundo orden, para reflejar un movimiento real, ya que tenemos aceleración y velocidad, donde por simplicidad llamaremos $y$ a $f(x)$ $$ y + k_1 \dot{y} + k_2 \ddot{y} = x + k_3 \dot{x} $$
