...
---
Una solución analítica a este problema es una expresión en forma cerrada que dado la [[ingeniería electrónica/robótica móvil/Repaso álgebra/Pose|pose final]], devuelve la configuración para llegar a esa posición. Esta existe si los [[Grado de libertad|grados de libertad]] de la posición final, es menor a los grados de libertad que da la configuración
