...
tales que las columnas de $Q$ son una [[Base ortonormal]] de $col(A)$ considerando el producto interno canonico de $\mathbb{R}^m$ y $R$ es triangular superior con numeros positivos en la diagonal principal
...
Donde encontramos los $\alpha_{ij}$, planteando el [[Metodo de Gram-Schmidt]], con $col(a) = \{a_1, a_2, \cdots, a_n \}$
 ...
 * $Q^T Q = [P_{col(A)}]_E^E$, donde encontramos [[Matriz de la proyeccion ortogonal]]
 * $T(x)=QQ^T(x)$ siendo un [[Proyector]], tiene las propiedades
