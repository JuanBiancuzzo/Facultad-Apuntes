...
$T$ es inyectiva, si $T(v_1) = T(v_2)$ entonces $v_1 = v_2$, tambien se puede comprobar que es monomorfismo si el [[Nucleo de una transformacion lineal]] es $\{0_{\mathbb{W}}\}$
