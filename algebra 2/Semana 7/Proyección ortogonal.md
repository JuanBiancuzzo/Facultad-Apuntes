...
Se puede encontrar $\hat{v}$ teniendo una base con el [[Sistema ortogonal|sistema ortogonal]] de $S$ tal que $B_S = \{v_1, v_2, \cdots, v_r \}$ (que si tenemos una base pero esta no es ortogonal, entonces podemos usar el [[Metodo de Gram-Schmidt]] para convertirlo en ortogonal), entonces
