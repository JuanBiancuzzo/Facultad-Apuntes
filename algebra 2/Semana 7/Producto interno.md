...
### Definición
---
Sea $\mathbb{V}$ un $\mathbb{K}$-espacio vectorial. Un producto interno en $\mathbb{V}$ es una función $\langle \cdot , \cdot \rangle : \mathbb{V} \times \mathbb{V} \to \mathbb{K}$, tal que
