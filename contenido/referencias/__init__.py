...
from .youtube import ReferenciaYoutube, ReferenciaYoutube as Youtube
from .wikipedia import ReferenciaWikipedia, ReferenciaWikipedia as Wikipedia
from .website import ReferenciaWeb, ReferenciaWeb as Web
