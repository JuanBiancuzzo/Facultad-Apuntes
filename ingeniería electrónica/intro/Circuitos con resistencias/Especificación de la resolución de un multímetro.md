...
- El primer valor (es siempre entero) corresponde a la cantidad de dígitos que van del 0 al 9 en el display del [[ingeniería electrónica/intro/Multimetro/Multímetro|multímetro]]
