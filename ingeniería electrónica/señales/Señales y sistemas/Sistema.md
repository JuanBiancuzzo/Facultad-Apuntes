...
La forma de [[ingeniería en informática/ingenieria de software 1/Diseño de software/Modelar|modelizar]] un sistema de forma universal, de forma matemática e independiente de su naturaleza física, es con un [[Operador|operador]] que pueda operar entre dos [[Espacio vectorial|espacios]] de [[Señal|señales]]
