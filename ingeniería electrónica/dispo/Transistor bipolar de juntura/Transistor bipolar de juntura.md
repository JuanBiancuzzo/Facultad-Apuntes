...
# Definición
---
El [[Transistor]] bipolar de juntura es la superposición de tres regiones con [[Dopaje|dopajes]] contrarios, formando dos [[Juntura PN|junturas PN]]. Estas tienen que estar suficientemente juntas como para que los [[Carga eléctrica|portadores]] minoritarios interactúen (pueden difundirse rápido sin [[ingeniería electrónica/dispo/Física de semiconductores/Recombinación de portadores|recombinarse]] en la base). También tiene que estar suficientemente separados como para que las regiones de deserción (SCR) no se solapen (punch-through)
