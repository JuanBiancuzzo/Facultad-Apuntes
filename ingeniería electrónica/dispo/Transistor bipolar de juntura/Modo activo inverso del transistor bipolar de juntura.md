...
La base inyecta [[Hueco|huecos]] al colector, se [[ingeniería electrónica/dispo/Física de semiconductores/Recombinación de portadores|recombinan]] en el contacto con el colector y el sustrato $$ I_B = \frac{I_S}{\beta_R} ~ \left( \exp \left( \frac{V_{BC}}{V_{th}} \right) - 1\right) $$donde $\beta_F$ es la [[Ganancia de corriente en modo activo inverso|ganancia de corriente en MAI]]
