...
# Definición
---
Este representa un [[ingeniería electrónica/quimica/Química orgnánica e inorgánica/Hidrocarburo|hidrocarburo]] donde el [[ingeniería electrónica/quimica/Química orgnánica e inorgánica/Grupo funcional|grupo funcional]] es un [[Carbonilo|carbonilo]] $(\text{C} \text{O})$ donde el enlace es un [[ingeniería electrónica/quimica/Enlaces químicos/Unión covalente#^doble|enlace doble]]. A diferencia de los [[ingeniería electrónica/quimica/Química orgnánica e inorgánica/Aldehído|aldehídos]], el grupo funcional se encuentra enlazado (por medio del [[Carbono|carbono]]) a otros dos carbonos

## Nomenclatura
---
Se nombre el hidrocarburo y se agregar el sufijo "-ona". En el caso que no sea evidente, se agrega el número del carbono que está enlazado
...
\begin{tikzpicture}[scale=1.7, transform shape, thick]
	...
	\coordinate (grupo_oxigeno) at ($ (cadena_2) + (0, \sep) $);
...
Tenemos una cadena principal de $3$ carbonos, como el grupo carbonilo tiene que estar conectado a otros $2$ carbonos, solo existe una única ubicación en la que puede estar, por lo que se nombre propanona. También es conocido como acetona ^acetona