...
> [!proposicion]+ Proposición 1.2.28 
...
## Algoritmo
---
> [!teorema]+ Teorema 1.3.1 (Algoritmo de Euclides)
...
> \end{array} $$
> se llega por primera vez el resto nulo $r_{l + 1} = 0$. Entonces $(a ~:~ b) = r_l$, el último resto no nulo
> 
