...
* Practial Mathematics de Reginald Stevens Kimball
* The mathematical principles of natural philosophy de Isaac newton
* Math in drag de Kyne
* elliptic curves, modular forms and their l-functions de alvaro lozano-robledo
* Complex analysis: a self-study guide by terrence murphy
...
* The Oxford Solid State Basics (by S. H. Simon)recommend the online lecture series “The Oxford Solid State Basics” on YouTube.
* Mathematical Methods for Physicists (by Arfken & Weber)
* Concepts in Thermal Physics (by Blundell & Blundell)
* Introduction to Electrodynamics (by David J. Griffths)
