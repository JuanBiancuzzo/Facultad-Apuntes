...
# Definición
---
Se dice que una [[Variable aleatoria]] $X$ tiene distribución de Pareto de parámetros $m$ y $\alpha$ si su [[Función de densidad de probabilidad]] es $$ f_X(x) = \frac{\alpha \cdot m^\alpha}{x^{\alpha + 1}} $$
