...
# Enunciado
---
Considere el [[ingeniería en informática/orga/Machine learning/Problema de regresión|problema de regresión]] asociado a la [[ingeniería en informática/proba/Variables y vectores aleatorios/Función de densidad de probabilidad#Para vector aleatoria|densidad de probabilidad conjunta]] a continuación $$ p_{X,~ Y}(x,~ y) = \frac{1}{2x + 1} \exp\left( -\left( 2x + \frac{y}{4x + 2} \right) \right) ~ \mathbb{1}\Set{ x \ge 0,~ y \ge 0 } $$
