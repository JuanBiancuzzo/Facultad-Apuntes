...
Se realiza una modificaciń en la placa de montaje a la brida de manera que la pieza queda rotada $10\degree$ en sentido de $Z_{\text{tool}0}$ positivo. Indicar cuál será la nueva orientación definida a la herramienta
1. $Q = \left( \cos(5\degree),~ 0,~ 0,~ \sin(5\degree) \right)$ ^parte-1
2. $Q = \left( \cos(10\degree),~ 0,~ 0,~ -\sin(10\degree) \right)$ ^parte-2
3. $Q = \left(1,~ 0,~ 0,~ 0 \right)$ ^parte-3
4. $Q = \left( \cos(5\degree),~ 0,~ 0,~ -\sin(5\degree) \right)$ ^parte-4
5. $Q = \left( \cos(10\degree),~ 0,~ 0,~ \sin(10\degree) \right)$ ^parte-5
