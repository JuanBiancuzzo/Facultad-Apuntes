...
Lo más importante del método de nuestro [[Código Civil y Comercial de la Nación|Código]] es la reunión de las disposiciones comunes a todos los [[Contrato|contratos]] en un título particular. De todos modos, nos parece importante poner de relieve que esta parte general de los contratos no se agota en el [[Título 2, Contratos en general|título II del Libro Tercero]]. En efecto, no podrá prescindirse: 
