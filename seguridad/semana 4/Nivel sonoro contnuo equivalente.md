...
### Definición
---
Es el nivel [[Presión sonora|sonoro]] medido en [[Decibel#Decibeles A|decibeles "A"]] de un [[Ruido]] supuesto constante y continuo durante toda la jornada laboral, cuya energía sonora sea igual a la del ruido variable medio estadisticamente a lo largo de la misma.
...
El limite admisible por la resolución 295/03 es de $85dBA$ para una exposición de $8hs$. En el caso de una exposicion variable se aplica la condición que $$ \sum_i \frac{C_i}{T_i} \le 1 $$
